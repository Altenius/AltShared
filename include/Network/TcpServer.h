...
public:
    ...
    {
    public:
        virtual void onConnection(evutil_socket_t sock)
        {
    ...
    static TcpServerPtr bind(Callbacks &callbacks,
...
public:
    static void onConnection(evconnlistener *listener, evutil_socket_t sock,
