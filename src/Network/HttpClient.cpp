...
protected:
    HttpRequest(HttpClient::HttpMethod method, const std::string &url,
                HttpClient::Callbacks *callbacks, const std::string &body,
                HttpHeader header, CookieJarPtr cookieJar) : method_(method), url_(url), callbacks_(callbacks),
                                                             body_(body), header_(header), parser_(this),
...
HttpRequest::request(HttpClient::HttpMethod method, const std::string &url, HttpClient::Callbacks *callbacks,
